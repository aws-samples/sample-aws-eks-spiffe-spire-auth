...
variable "root_cluster_node_iam_role_arn" {
  description = "ARN of the root cluster managed node group IAM role"
  type        = string
  default     = "arn:aws:iam::111122223333:role/general-instances-eks-node-group-20240101000000000000000001"
}

variable "root_cluster_iam_role_arn" {
  description = "ARN of the root cluster EKS cluster IAM role"
  type        = string
  default     = "arn:aws:iam::111122223333:role/spire-root-cluster-cluster-20240101000000000000000002"
}

variable "root_cluster_spire_tools_iam_role_arn" {
  description = "ARN of the root cluster SPIRE tools access IAM role"
  type        = string
  default     = "arn:aws:iam::111122223333:role/spire-root-cluster-spire-server-role"
}